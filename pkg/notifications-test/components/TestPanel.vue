...
import { Notification, NotificationLevel } from '../types/notifications.ts';
...
<template>
  <div class="panel">
    ...
    <div class="actions">
      ...
      >
        Start update of progress for the task notification
      </button>
      <button
        class="btn btn-sm role-primary"
        @click="reset()"
      >
        Reset release notes read status
      </button>
      <button
        class="btn btn-sm role-primary"
        @click="growl()"
